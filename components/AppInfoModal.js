  ...
  render() {
    return (
      <View style={styles.about}>
        <Modal style={styles.modal} animationType="fade" transparent={false} visible={this.state.modalVisible}>
          <View style={styles.modal}>
            <View>
              <Text style={styles.titleText}>instaChat App</Text>
              ...
              <TouchableOpacity onPress={ () => { this.setState({modalVisible: false}); } }>
                <Icon style={styles.close} name="ios-close-circle-outline" size={40} color="#ccc6bf"/>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
        <TouchableOpacity onPress={ () => { this.setState({modalVisible: true}); } }>
          <Icon name="ios-information-circle-outline" size={30} color="#ccc6bf"/>
        </TouchableOpacity>
      </View>
    );
  }
